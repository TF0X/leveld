...
export const RANKS = [
  { lvl: 1,  name: 'Couch Potato' },
  { lvl: 2,  name: 'Off the Sofa' },
  { lvl: 3,  name: 'Rookie' },
  { lvl: 4,  name: 'Showing Up' },
  { lvl: 5,  name: 'Grinder' },
  { lvl: 6,  name: 'Hustler' },
  { lvl: 7,  name: 'Consistent' },
  { lvl: 8,  name: 'Committed' },
  { lvl: 9,  name: 'No Days Off' },
  { lvl: 10, name: 'Dedicated' },
  { lvl: 11, name: 'Iron Willed' },
  { lvl: 12, name: 'Disciplined' },
  { lvl: 13, name: 'Focused' },
  { lvl: 14, name: 'Locked In' },
  { lvl: 15, name: 'Athlete' },
  { lvl: 16, name: 'Warrior' },
  { lvl: 17, name: 'Relentless' },
  { lvl: 18, name: 'Machine' },
  { lvl: 19, name: 'Savage' },
  { lvl: 20, name: 'Champion' },
  { lvl: 22, name: 'Shredded' },
  { lvl: 24, name: 'Alpha' },
  { lvl: 26, name: 'Beast Mode' },
  { lvl: 28, name: 'Unstoppable' },
  { lvl: 30, name: 'Elite' },
  { lvl: 33, name: 'Apex' },
  { lvl: 36, name: 'Titan' },
  { lvl: 40, name: 'Overlord' },
  { lvl: 45, name: 'Demigod' },
  { lvl: 50, name: 'Legend' },
  { lvl: 60, name: 'GOD MODE' },
];
